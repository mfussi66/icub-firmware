...
{
  real32_T estimation_velocity::estimation_velocity_xnrm2(int32_T n, const
    real32_T x[32], int32_T ix0)
  {
    real32_T absxk;
    real32_T y;
    y = 0.0F;
  ...
  void estimation_velocity::estimation_velocity_xgeqp3(const real32_T A[32],
    real32_T b_A[32], real32_T tau[2], int32_T jpvt[2])
  {
    int32_T b_k;
    int32_T ix;
    int32_T lastv;
...
namespace amc_bldc_codegen
{
  ...
  void estimation_velocity::init(void)
  {
  ...
  void estimation_velocity::initialize()
  {
    // Registration code
  ...
  // Constructor
  estimation_velocity::estimation_velocity() :
    estimation_velocity_DW(),
    estimation_velocity_M()
  {
  ...
  amc_bldc_codegen::estimation_velocity::RT_MODEL_estimation_velocity_T
    * estimation_velocity::getRTM()
  {
    return (&estimation_velocity_M);
  }

  // member function to setup error status pointer
  void estimation_velocity::setErrorStatusPointer(const char_T **rt_errorStatus)
  {
