...
namespace amc_bldc_codegen
{
    ...
    const ControlOuterOutputs *rtu_OuterOutputs, ControlOutputs *rty_FOCOutputs)
  {
    ...
    if (rtb_PProdOut_k > rtu_ConfigurationParameters->motorconfig.Vmax) {
      rtb_PProdOut_k = rtu_ConfigurationParameters->motorconfig.Vmax;
    } else if (rtb_PProdOut_k < -rtu_ConfigurationParameters->motorconfig.Vmax)
    {
    ...
    rtb_IaIbIc0[0] = rtb_algDD_o1_p * rtb_SinCos_o2 + rtb_PProdOut_k *
      rtb_SinCos_o1;
    ...
    if (rtu_OuterOutputs->out_en) {
      ...
      rtb_SinCos_o1 = -(rtb_PProdOut_k * rtb_SinCos_o2 - rtb_algDD_o1_p *
