    ...
    const ControlOuterOutputs *rtu_OuterOutputs, ControlOutputs *rty_FOCOutputs)
  {
    ...
    if (rtu_OuterOutputs->out_en) {
      ...
      if (rtb_Unary_Minus > 100.0F) {
        ...
        rty_FOCOutputs->Vabc[0] = rtb_Unary_Minus;
      }
      ...
      rtb_Unary_Minus = (rtb_SinCos_o1 - rtb_SinCos_o2) /
        rtu_ConfigurationParameters->motorconfig.Vcc * 100.0F + 50.0F;
      ...
      if (rtb_Unary_Minus > 100.0F) {
        ...
        rty_FOCOutputs->Vabc[1] = rtb_Unary_Minus;
      }
      ...
      if (rtb_Unary_Minus > 100.0F) {
        ...
        rty_FOCOutputs->Vabc[2] = rtb_Unary_Minus;
      }
    } else {
      rty_FOCOutputs->Vabc[0] = 0.0F;
      rty_FOCOutputs->Vabc[1] = 0.0F;
